...
public:
    ...
    void AddDocument(int document_id, const string& document, DocumentStatus status,
       ...
       const vector<string> words = SplitIntoWordsNoStop(document); // МБ
    ...
    int GetDocumentId(int index) const {
        ...
        if (index > static_cast<int>(ids.size()) - 1 || index < 0 || ids.empty())
            throw out_of_range("request document_id out of range");
